...
#测试图片
org = cv2.imread('./ir1/undist/0000000039.png')
org2 = cv2.imread('./ir2/undist/0000000039.png')
...
canvas[:, :640] = dst
canvas[:, 640:] = dst2
cv2.line(canvas, (640, 0), (640, 480), (255,0,0), 1)
...
#测试图片
org = cv2.imread('./ir1/undist/0000000040.png')
org2 = cv2.imread('./ir2/undist/0000000040.png')
